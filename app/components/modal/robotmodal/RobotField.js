...
const RobotField = ()=> {
  ...
  return (
    <div className="RobotField">
      <header className="RobotField-header">
          <Field
        ...
        <div className="submit-button text-black bg-blue-500  font-bold py-2 px-4 rounded text-sm">
          <label>
            Coordinates:<br/>
            <input type="text" className="coordinates mb-2" value={coordinates} onChange={(e)=>setcoordinates(e.target.value)}/>
          </label><br/>
          <button className='bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded' onClick={()=>{handleSubmitCoordinate(coordinates)}}>Submit
          </button>
        </div>
